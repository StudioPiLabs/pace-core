...
class Gaze:
    ...
    the storyboard records "Emily looking at the tablet" or
...
class Subject:
    ...
    character_id: Optional[str] = None               # id matching kb/on_scene/characters.json, e.g. "emily"
...
class WorldEntity:
    ...
    `ref` is a character ref ("emily@adult_50") or prop_id ("tablet")."""
