...
Across the 33 staged panels of AutomaticDrive, a greybox's own flat-region
...
Measured on scene_03/shot_01, one seed, one prompt, the same ``line_art_clean``
...
=============  =======  =====  =====================  =====  ================
init           denoise  flat%  top (ryan/emily/ethan)  pos    delivered
=============  =======  =====  =====================  =====  ================
